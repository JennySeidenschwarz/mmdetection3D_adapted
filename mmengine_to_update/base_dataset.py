# Copyrighc (c) OpenMMLab. All rights reserved.
import copy
import functools
import gc
import logging
...
class BaseDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 ann_file2: Optional[str] = '',
                 detection_type='train_detector',
                 detection_type2='train_gnn',
                 all_car=False):
        self.ann_file = ann_file
        self.detection_type = detection_type
        self.ann_file2 = ann_file2
        self.detection_type2 = detection_type2
        ...
        # DEBUGGING PREPARE DATA
        # self.prepare_data_debug()
        # quit() 
    ...
    def full_init(self):
        ...
        self.data_list = self.load_data_list(self.detection_type)
        print("Loaded data source 1...")
    ...
    def load_data_list(self, detection_type=None) -> List[dict]:
        ...
        if detection_type is None:
            if 'waymo_kitti_format_annotaions/' not in str(self.ann_file):
                detection_type = 'detector'
            # elif 'val' in str(self.ann_file):
            #     detection_type = 'evaluation'
            else:
                detection_type = 'gnn'
        '''
        annotations = load(
