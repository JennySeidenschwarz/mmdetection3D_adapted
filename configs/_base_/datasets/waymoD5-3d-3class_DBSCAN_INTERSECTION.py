...
db_sampler = dict(
    ...
    info_path=data_root_annotatons_dets + f'DBSCAN_INTERSECTION_NEW_FLOW_VAL_DETECTPOR_0_all_egocomp_margin0.6_width25_flow_0.1_10/waymo_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root_annotatons_dets,
            ann_file=f'DBSCAN_INTERSECTION_NEW_FLOW_VAL_DETECTION_0_all_egocomp_margin0.6_width25_traj_0.1_10_1.0_10_1.0/waymo_infos_train.pkl',
            data_prefix=dict(
