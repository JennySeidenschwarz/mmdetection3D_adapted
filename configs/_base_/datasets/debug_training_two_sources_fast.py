...
data_root_annotatons_dets = f'/workspace/result/kitti_format/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root_annotatons_dets,
            ann_file=f'{data_root_annotatons_dets}debug_training/waymo_infos_train.pkl',
            ann_file2=f'{data_root_annotatons_dets}debug_training/waymo_infos_train.pkl',
            data_prefix=dict(
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root_annotatons_dets,
        data_prefix=dict(pts='{data_root}training/velodyne', sweeps='training/velodyne'),
        ann_file=f'{data_root_annotatons_dets}debug_training/waymo_infos_train.pkl',
