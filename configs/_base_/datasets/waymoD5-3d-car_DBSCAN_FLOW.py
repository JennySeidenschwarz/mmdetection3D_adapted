...
detection_name = 'RECOMPUTE_REMOVE_BUG_HEADING_DBSCAN_FLOW_NEW_FLOW_VAL_DETECTPOR_0.5_0.1_all_egocomp_margin0.6_width25_flow_0.1_10_0' # 'pointpillars_hv_secfpn_sbn-all_16xb2-2x_waymo-3d-car_50_train_gnn_split_0.0_0.5'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            ann_file=f'{data_root_annotatons_dets}{detection_name}/waymo_infos_train.pkl',#f'DBSCAN_FLOW_NEW_FLOW_VAL_DETECTPOR_0_all_egocomp_margin0.6_width25_flow_0.1_10/waymo_infos_train.pkl',
            data_prefix=dict(
