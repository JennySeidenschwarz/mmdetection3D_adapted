...
detection_name = 'RECOMPUTE_REMOVE_BUG_HEADING_10_EVAL_TRAIN_DET_0.1_0.1_all_egocomp_margin0.6_width25_nooracle_64_64_64_64_0.5_3.5_0.5_4_3.162277660168379e-06_0.0031622776601683794_16000_16000__NS_MG_32_2.0_LN__0'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root_annotatons_dets,
            ann_file=f'{data_root_annotatons_dets}{detection_name}/waymo_infos_train.pkl', #f'{data_root_annotatons_dets}{detection_name}/waymo_infos_train.pkl',
