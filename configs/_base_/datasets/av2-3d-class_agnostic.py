...
original_dataset_root = f'{root_dir}data/AV2/'
flow_path = f'{root_dir}data/AV2_Flow/'
filtered_file_path = f'SeMoLi/data_utils/AV2_filtered/'
split_path = f'{root_dir}/SeMoLi/data_utils/new_seq_splits_AV2_fixed_val/'
