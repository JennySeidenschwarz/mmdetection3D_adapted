...
data_root_annotations = '/workspace/waymo_kitti_format_annotaions/kitti_format/'
...
db_sampler = dict(
    ...
    info_path=data_root_annotations + 'waymo_dbinfos_train.pkl',
    rate=1.0,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=f'{data_root_annotations}/waymo_infos_train.pkl',
            data_prefix=dict(
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=f'{data_root_annotations}/waymo_infos_train.pkl',
        # ann_file=f'{data_root_annotations}/waymo_infos_val.pkl',
...
val_evaluator = dict(
    ...
    # ann_file='{data_root}/{rel_annotations_dir}/waymo_infos_val.pkl',
    waymo_bin_file='waymo_gt_and_meta/gt/gt_0.1_val_detector.bin', #f'{waymo_root}/gt.bin',
