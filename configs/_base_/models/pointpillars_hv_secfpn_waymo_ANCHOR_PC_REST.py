...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[[-50, -20, -2, 50, 20, 4], #[-74.88, -74.88, -0.0345, 74.88, 74.88, -0.0345],
                    [-50, -20, -2, 50, 20, 4], # [-74.88, -74.88, 0, 74.88, 74.88, 0],
                    [-50, -20, -2, 50, 20, 4]], #[-74.88, -74.88, -0.1188, 74.88, 74.88, -0.1188]],
            sizes=[
                [4.73, 2.08, 1.77],  # car
